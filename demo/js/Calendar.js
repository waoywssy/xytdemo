...
function fPopCalendar(evt,popCtrl,dateCtrl){  
    ...
    if(gdCtrl.innerHTML == ''){
        ...
        var aDates = gdCtrl.innerHTML.split('-')
...
function fHideCalendar(){$$("calendardiv").style.display="none";for(var i=0;i<goSelectTag.length;i++){goSelectTag[i].style.display="block";}goSelectTag.length=0;}
...
function getDateDiv(){  
    ...
    var dateDiv="";  
    dateDiv += "<div id='calendardiv'  onclick='event.cancelBubble=true' " + noSelectForIE + " style='" + noSelectForFireFox + "position:absolute;z-index:99999;display:none;border:1px solid #999999;width:174px;'>";
